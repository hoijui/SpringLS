 ...
 * @author hoijui
 */
@SupportedCommand("SAYDATABATTLE")
public class SayDataBattleCommandProcessor extends SayBattleCommandProcessor {

	public SayDataBattleCommandProcessor() {
		super("SAIDDATABATTLE");
	}
}
