...
public class Account implements Serializable, Cloneable {
	...
	public static enum Access {
		...
		public boolean isAtLeast(final Access otherAccess) {
			return this.compareTo(otherAccess) >= 0;
		}

		public boolean isLessThen(final Access otherAccess) {
			return this.compareTo(otherAccess) < 0;
		}
	}
	...
	public Account(
			...
			final InetAddress lastIp,
			final long registrationDate,
			final String lastCountry,
			final int id,
			final boolean bot,
			final long inGameTime,
			final boolean agreementAccepted,
			final String email)
	{
		this.id                = id;
		this.name              = name;
	...
	private Account(final Account acc) {
	...
	public static Access extractAccess(final int accessBitField) {
	...
	public static long extractInGameTime(final int accessBitField) {
		return ((accessBitField & 0x7FFFF8) >> 3) * 60L;
	}
	public static boolean extractAgreementAccepted(final int accessBitField) {
		return ((accessBitField & 0x800000) >> 23) == 1;
	}
	public static boolean extractBot(final int accessBitField) {
	 ...
	 */
	public static String isPasswordValid(final String toCheckPassword) {
	 ...
	 */
	public static String isOldUsernameValid(final String userName) {
	 ...
	 */
	public static String isNicknameValid(
	 ...
	 */
	public boolean addMinsToInGameTime(final long mins) {
	 ...
	 */
	protected void setRegistrationDate(final long registrationDate) {
		this.registrationDate = registrationDate;
	}
	 ...
	 */
	public void setLastUserId(final int lastUserId) {
		this.lastUserId = lastUserId;
	}
	 ...
	 */
	public void setLastCountry(final String lastCountry) {
		this.lastCountry = lastCountry;
	}
	 ...
	 */
	public void setAgreementAccepted(final boolean agreementAccepted) {
		this.agreementAccepted = agreementAccepted;
	}
